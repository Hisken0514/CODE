...
def load_data(data_dir):
    ...
    for label in range(1,6):  
        ...
        for img_name in os.listdir(dir_path):
            ...
            img = load_img(img_path, color_mode='grayscale', target_size=(width, height))  # 調整圖片大小
...
x_flatten = x_data.reshape(x_data.shape[0], -1)  # 將 100x30x1 展平
...
# 顯示混淆矩陣
plt.figure(figsize=(8, 6))
disp = ConfusionMatrixDisplay(confusion_matrix=conf_matrix, display_labels=range(1, 6))  # 設置標籤為1~5
